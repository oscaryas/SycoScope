...
Usage:
    python -m probing.evaluations.generation.generate_social --dataset oeq \\
        --model meta-llama/llama-3.1-8b-instruct --backend openrouter \\
        --output probing/data/baseline/meta-llama__llama-3.1-8b-instruct/oeq/checkpoint.jsonl

    python -m probing.evaluations.generation.generate_social --dataset ss \\
        --model meta-llama/Meta-Llama-3-8B-Instruct --backend local --system-prompt pe_explicit \\
        --output probing/data/system_prompt/meta-llama__Meta-Llama-3-8B-Instruct/pe_explicit/ss.jsonl
"""
