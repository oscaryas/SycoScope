...
Usage:
    python -m probing.evaluations.baseline_probes.generation.verify_model_generation_setup
    python -m probing.evaluations.baseline_probes.generation.verify_model_generation_setup --models Qwen/Qwen3-8B
"""
import argparse
import sys
