...
baseline_probes.collect_activations (always extracts MHA + MLP + residual
...
from probing.probe.baseline_probes import _pool, train_residual_probes, save_probe_results
...
def collect_residual_only(model, tokenizer, texts: list, model_config: dict, max_length: int = 1024, pooling: str = "mean") -> np.ndarray:
    ...
    convention as baseline_probes.collect_activations (mean over the
