...
Usage:
    python plot_all_probes.py --results-dir /path/to/results/oeq_probe_aita_transfer_sentence
"""
import argparse
import json
import pickle
...
def main():
    ...
    parser.add_argument(
        ...
        help="Directory holding {mha,mlp,residual}_accuracy.pkl, oeq_heldout_accuracy.json, "
             "and aita_transfer_accuracy.json (e.g. the oeq_probe_aita_transfer_pipeline.py "
             "run's own results/cross_domain_transfer/oeq_probe_aita_transfer_sentence output).",
    )
