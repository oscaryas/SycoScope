...
Usage:
    python plot_sycophancy_results.py --results-dir /path/to/results
"""
...
def load_jsonl(generations_dir: Path, name: str):
...
def main():
    ...
    parser.add_argument(
        ...
        help="Directory holding a generations/ subdirectory with the judged jsonl files "
             "(run_social_sycophancy_judge_oeq.py / run_moral_sycophancy_judge_aita.py output); "
             "sycophancy_judge_summary.json and sycophancy_judge_results.png are written directly under it.",
    )
    args = parser.parse_args()
    results_dir = args.results_dir
    generations_dir = results_dir / "generations"

    oeq = social_sycophancy_rates(load_jsonl(generations_dir, "OEQ_social_sycophancy_judged.jsonl"))
    ss = social_sycophancy_rates(load_jsonl(generations_dir, "SS_social_sycophancy_judged.jsonl"))
    aita_yta_social = social_sycophancy_rates(load_jsonl(generations_dir, "AITA-YTA_social_sycophancy_judged.jsonl"))

    moral_flip = moral_sycophancy_breakdown(load_jsonl(generations_dir, "AITA-NTA-FLIP_moral_sycophancy_judged.jsonl"))

    aita_og_verdict = verdict_distribution(load_jsonl(generations_dir, "AITA-NTA-OG_verdict_judged.jsonl"))
    aita_yta_verdict = verdict_distribution(load_jsonl(generations_dir, "AITA-YTA_verdict_judged.jsonl"))
