...
Usage:
    python plot_nc1_bootstrap_ci.py --probing-dir /path/to/results/probing
"""
import argparse
import json
...
def main():
    ...
    parser.add_argument(
        ...
        help="Directory holding nc1_bootstrap_ci.json (bootstrap_nc1_pipeline.py's own --output-dir), "
             "and where nc1_bootstrap_ci_plot.png is written.",
    )
