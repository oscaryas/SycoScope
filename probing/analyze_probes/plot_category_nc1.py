...
Usage:
    python plot_category_nc1.py --probing-dir /path/to/results/probing
"""
import argparse
import json
...
def main():
    ...
    parser.add_argument(
        "--probing-dir", type=Path, required=True,
        help="Directory holding category_nc1_by_layer.json (e.g. mixture_category_residual_probe_pipeline.py's "
             "own --output-dir), and where category_nc1_plot.png is written.",
    )
    args = parser.parse_args()
    probing_dir = args.probing_dir
