...
def main():
    ...
    parser.add_argument("--are-you-sure", type=str, default=str(HERE / "results" / "are_you_sure_pooled" / "pooled.jsonl"))
    parser.add_argument("--social", type=str, default=str(HERE / "results" / "social_sycophancy_pooled" / "pooled.jsonl"))
    parser.add_argument("--moral", type=str, default=str(HERE / "results" / "moral_sycophancy_pooled" / "pooled.jsonl"))
