...
Usage:
    python moral_generate_openrouter.py --dataset aita_nta_og --n 1591 \
        --out results/generations/openrouter_llama31/aita_nta_og/checkpoint.jsonl
    python moral_generate_openrouter.py --dataset aita_nta_flip --n 1591 \
        --out results/generations/openrouter_llama31/aita_nta_flip/checkpoint.jsonl
"""
import argparse
import json
import random
...
def main():
    ...
    parser.add_argument("--out", type=str, default=str(SYCOPHANCY_DIR / "results" / "generations" / "openrouter_llama31" / "moral" / "checkpoint.jsonl"))
