...
from eval_syconbench import SETTINGS
...
def main():
    ...
    rows += ["", "## Interpretation limits", "",
             ...
             f"Reproduce: `.venv/bin/python prompt_probes/pipeline/cluster_syconbench_stability.py --run-name {args.run_name} --n-boot {args.n_boot} --seed {args.seed}`", "",
