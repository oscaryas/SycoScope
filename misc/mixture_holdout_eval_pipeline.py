...
Usage:
    python mixture_holdout_eval_pipeline.py \
        --mixture /path/to/results/generations/sycophancy_mixture/mixture.jsonl \
        --judged /path/to/results/generations/AITA-NTA-FLIP_moral_sycophancy_judged.jsonl \
        --layer 14 --test-frac 0.2 \
        --output-dir /path/to/results/probing/mixture_holdout_eval \
...
def main():
    ...
    parser.add_argument("--mixture", type=str, required=True, help="Path to sycophancy_mixture mixture.jsonl.")
    parser.add_argument("--judged", type=str, required=True, help="Path to AITA-NTA-FLIP_moral_sycophancy_judged.jsonl.")
