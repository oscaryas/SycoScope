...
Usage:
    python bootstrap_nc1_pipeline.py \
        --input /path/to/results/generations/sycophancy_mixture/mixture.jsonl \
        --output-dir /path/to/results/probing \
...
def main():
    ...
    parser.add_argument("--input", type=str, required=True, help="Path to sycophancy_mixture mixture.jsonl.")
